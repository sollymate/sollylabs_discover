                    ...
                    child: Stack(alignment: Alignment.bottomRight, children: [
                      CircleAvatar(
                        ...
                        backgroundImage: _avatarImage != null
                            ...
                            : (_userProfile!.avatarUrl != null ? NetworkImage(_userProfile!.avatarUrl!) : const Placeholder(color: Colors.green))
...
//       }
//
//       String? avatarUrl = _userProfile!.avatarUrl; // Keep the existing URL if no new image is selected
//       if (_avatarImage != null) {
//         // Upload new avatar and get the URL
//         avatarUrl = await database.profileService.uploadAvatar(_userProfile!.id.uuid, _avatarImage!);
//       }
//
...
// // //                   child: CircleAvatar(
// // //                     radius: 50,
// // //                     // Use NetworkImage if URL is present, otherwise use placeholder
// // //                     backgroundImage: _userProfile!.avatarUrl != null ? NetworkImage(_userProfile!.avatarUrl!) : null,
// // //                     // If no image, display an upload icon
// // //                     child: _userProfile!.avatarUrl == null ? const Icon(Icons.camera_alt, size: 50) : null,
// // //                   ),
// // //                 ),
// // //                 const SizedBox(height: 20),
// // //                 TextFormField(
...
// // // //                     child: CircleAvatar(
// // // //                       radius: 50,
// // // //                       backgroundImage: _avatarImage != null ? FileImage(_avatarImage!) : (_userProfile!.avatarUrl != null ? NetworkImage(_userProfile!.avatarUrl!) : const AssetImage('assets/default_avatar.png')) as ImageProvider<Object>?,
// // // //                       child: _avatarImage == null && _userProfile!.avatarUrl == null ? const Icon(Icons.camera_alt, size: 50) : null,
// // // //                     ),
// // // //                   ),
// // // //                   const SizedBox(height: 20),
...
// // // // //       final database = Provider.of<Database>(context, listen: false);
// // // // //
// // // // //       print("Display ID Controller Text: ${_displayIdController.text}");
// // // // //       print("User Profile ID: ${_userProfile!.id.uuid}");
// // // // //
// // // // //       // Validate uniqueness of displayId if it's not null
// // // // //       if (_displayIdController.text.isNotEmpty) {
// // // // //         final isUnique = await database.profileService.isDisplayIdUnique(_displayIdController.text, _userProfile!.id.uuid);
...
// // // // //             );
// // // // //           }
// // // // //           print("Display ID is not unique");
// // // // //           return;
// // // // //         }
// // // // //       }
// // // // //
...
// // // // //       );
// // // // //
// // // // //       print("Updated Profile: ${updatedProfile.toJson()}");
// // // // //
// // // // //       try {
// // // // //         await database.profileService.updateProfile(updatedProfile);
...
// // // // //           ScaffoldMessenger.of(context).showSnackBar(
// // // // //             SnackBar(
// // // // //               content: Text('2 Error updating profile: $e'),
// // // // //               backgroundColor: Colors.red,
// // // // //             ),
// // // // //           );
// // // // //         }
